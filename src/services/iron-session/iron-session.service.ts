...
export async function getAuthSession(
  req?: NextRequest,
  res?: NextResponse
): Promise<IronSession<AuthSessionData>> {
  if (!req || !res) {
...
export async function getAuthSessionValue<K extends keyof AuthSessionData>(
  key: K,
  req?: NextRequest,
  res?: NextResponse
): Promise<AuthSessionData[K]> {
